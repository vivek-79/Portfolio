...
export default function Wizard(props) {
  ...
  useFrame((state,delta)=>{
    if(modelRef.current){
       ...
       modelRef.current.position.y= (Math.sin(state.clock.elapsedTime)*0.3)-1.3
    }
  })
  return (
    <group {...props} dispose={null} scale={0.05} position={[0.33,-1.3,0]} rotation={[0.1,0,0]} ref={modelRef}>
      <mesh
        castShadow
        receiveShadow
