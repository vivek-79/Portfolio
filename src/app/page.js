...
export default function Home() {
  ...
  return (
    <main className="flex w-full min-h-screen flex-col items-center justify-between relative">
      <img id="back-gnd"   src='/background/home-background.png' alt="background-img"  className="fixed left-0 top-0 w-full h-full object-center object-cover opacity-25 "></img>
